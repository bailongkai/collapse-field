...
const CARGO_WAVES: readonly WaveEntry[] = [
  ...
  { minute: 9, mix: mix(['robot', 0.25], ['dasher', 0.15], ['mech', 0.3], ['loader', 0.15], ['tractor', 0.07], ['repairDrone', 0.08]), minCount: 72, interval: 550, batch: 5, hpMult: 2.2, dmgMult: 1.2 },
  ...
  { minute: 12, mix: mix(['robot', 0.15], ['dasher', 0.15], ['mech', 0.3], ['loader', 0.25], ['tractor', 0.07], ['repairDrone', 0.08]), minCount: 92, interval: 500, batch: 6, hpMult: 2.5, dmgMult: 1.3 },
...
const LAB_WAVES: readonly WaveEntry[] = [
  ...
  { minute: 9, mix: mix(['spore', 0.3], ['infected', 0.25], ['spitter', 0.2], ['dasher', 0.1], ['splitter', 0.15]), minCount: 200, interval: 300, batch: 11, hpMult: 1.9, dmgMult: 1.2 },
  ...
  { minute: 12, mix: mix(['spore', 0.25], ['infected', 0.2], ['spitter', 0.25], ['dasher', 0.1], ['splitter', 0.2]), minCount: 260, interval: 250, batch: 13, hpMult: 2.35, dmgMult: 1.25 },
