...
const WAVES: readonly WaveEntry[] = [
  ...
  { minute: 3, mix: mix(['drone', 0.4], ['infected', 0.4], ['robot', 0.2]), minCount: 50, interval: 650, batch: 4, hpMult: 1.3, dmgMult: 1.05 },
  { minute: 4, mix: mix(['infected', 0.5], ['robot', 0.3], ['interceptor', 0.2]), minCount: 60, interval: 600, batch: 5, hpMult: 1.4, dmgMult: 1.1 },
  { minute: 5, mix: mix(['infected', 0.5], ['robot', 0.3], ['interceptor', 0.2]), minCount: 70, interval: 600, batch: 5, hpMult: 1.5, dmgMult: 1.1 },
  { minute: 6, mix: mix(['infected', 0.4], ['robot', 0.4], ['mech', 0.2]), minCount: 85, interval: 550, batch: 5, hpMult: 1.65, dmgMult: 1.15 },
  { minute: 7, mix: mix(['drone', 0.3], ['robot', 0.4], ['mech', 0.3]), minCount: 100, interval: 500, batch: 6, hpMult: 1.8, dmgMult: 1.15 },
  { minute: 8, mix: mix(['infected', 0.3], ['robot', 0.4], ['mech', 0.3]), minCount: 115, interval: 500, batch: 6, hpMult: 1.95, dmgMult: 1.2 },
  { minute: 9, mix: mix(['robot', 0.4], ['interceptor', 0.3], ['mech', 0.3]), minCount: 130, interval: 450, batch: 6, hpMult: 2.1, dmgMult: 1.2 },
  { minute: 10, mix: mix(['robot', 0.4], ['mech', 0.4], ['interceptor', 0.2]), minCount: 150, interval: 450, batch: 7, hpMult: 2.25, dmgMult: 1.25 },
  { minute: 11, mix: mix(['infected', 0.3], ['robot', 0.3], ['mech', 0.4]), minCount: 170, interval: 400, batch: 7, hpMult: 2.4, dmgMult: 1.25 },
  { minute: 12, mix: mix(['drone', 0.3], ['robot', 0.3], ['mech', 0.4]), minCount: 190, interval: 400, batch: 8, hpMult: 2.5, dmgMult: 1.3 },
  { minute: 13, mix: mix(['robot', 0.3], ['interceptor', 0.3], ['mech', 0.4]), minCount: 220, interval: 350, batch: 8, hpMult: 2.5, dmgMult: 1.3 },
  { minute: 14, mix: mix(['robot', 0.3], ['mech', 0.5], ['interceptor', 0.2]), minCount: 250, interval: 300, batch: 10, hpMult: 2.5, dmgMult: 1.3 },
];
