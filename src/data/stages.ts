...
const CARGO_WAVES: readonly WaveEntry[] = [
  ...
  { minute: 4, mix: mix(['drone', 0.2], ['robot', 0.4], ['dasher', 0.2], ['mech', 0.15], ['loader', 0.05]), minCount: 42, interval: 700, batch: 4, hpMult: 1.45, dmgMult: 1.1 },
  { minute: 5, mix: mix(['robot', 0.45], ['dasher', 0.2], ['mech', 0.25], ['loader', 0.1]), minCount: 48, interval: 700, batch: 4, hpMult: 1.6, dmgMult: 1.1 },
  { minute: 6, mix: mix(['robot', 0.4], ['dasher', 0.2], ['mech', 0.25], ['loader', 0.15]), minCount: 54, interval: 650, batch: 4, hpMult: 1.75, dmgMult: 1.15 },
  ...
  { minute: 9, mix: mix(['robot', 0.3], ['dasher', 0.2], ['mech', 0.3], ['loader', 0.2]), minCount: 72, interval: 550, batch: 5, hpMult: 2.2, dmgMult: 1.2 },
  ...
  { minute: 12, mix: mix(['robot', 0.2], ['dasher', 0.2], ['mech', 0.3], ['loader', 0.3]), minCount: 92, interval: 500, batch: 6, hpMult: 2.5, dmgMult: 1.3 },
...
const ORBIT_WAVES: readonly WaveEntry[] = [
  ...
  { minute: 4, mix: mix(['drone', 0.45], ['raider', 0.2], ['interceptor', 0.15], ['escort', 0.1], ['infected', 0.1]), minCount: 46, interval: 650, batch: 4, hpMult: 1.4, dmgMult: 1.1, speedMult: 1.05 },
  ...
  { minute: 6, mix: mix(['raider', 0.35], ['interceptor', 0.3], ['escort', 0.2], ['dasher', 0.15]), minCount: 72, interval: 550, batch: 5, hpMult: 1.65, dmgMult: 1.15, speedMult: 1.15 },
  ...
  { minute: 9, mix: mix(['raider', 0.3], ['interceptor', 0.3], ['escort', 0.25], ['dasher', 0.15]), minCount: 115, interval: 450, batch: 6, hpMult: 2.1, dmgMult: 1.2, speedMult: 1.25 },
  ...
  { minute: 12, mix: mix(['raider', 0.3], ['interceptor', 0.3], ['escort', 0.2], ['mech', 0.2]), minCount: 175, interval: 400, batch: 8, hpMult: 2.5, dmgMult: 1.3, speedMult: 1.35 },
