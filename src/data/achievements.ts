...
export const ACHIEVEMENTS = {
  ...
  clearReactor: { id: 'clearReactor', nameKey: 'achievement.clearReactor.name', descKey: 'achievement.clearReactor.desc', icon: 'decor_reactor_0', condition: { kind: 'survive', seconds: 900, stageId: 'reactor' }, unlocks: { gold: 1200 } },
  clearDerelict: { id: 'clearDerelict', nameKey: 'achievement.clearDerelict.name', descKey: 'achievement.clearDerelict.desc', icon: 'decor_derelict_0', condition: { kind: 'survive', seconds: 900, stageId: 'derelict' }, unlocks: { gold: 1400 } },
  clearFoundry: { id: 'clearFoundry', nameKey: 'achievement.clearFoundry.name', descKey: 'achievement.clearFoundry.desc', icon: 'decor_foundry_0', condition: { kind: 'survive', seconds: 900, stageId: 'foundry' }, unlocks: { gold: 1600 } },
  clearSingularity: { id: 'clearSingularity', nameKey: 'achievement.clearSingularity.name', descKey: 'achievement.clearSingularity.desc', icon: 'decor_singularity_0', condition: { kind: 'survive', seconds: 900, stageId: 'singularity' }, unlocks: { gold: 2500 } },
